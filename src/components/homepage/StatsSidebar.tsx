...
export const StatsSidebar = () => {
  ...
  const currentlyReadingBooks = library.reading || [];
          ...
          <div className="grid grid-cols-2 gap-2">
            <Card>
              <CardContent className="p-3 flex flex-col items-center justify-center">
                ...
                <div className="text-xl font-bold">{library.tbr.length}</div>
            ...
            <Card>
              <CardContent className="p-3 flex flex-col items-center justify-center">
                ...
                <div className="text-xl font-bold">{library.read.length}</div>
