...
export const LibraryTabList: React.FC<LibraryTabListProps> = ({ activeTab, setActiveTab }) => {
  return (
    <TabsList className="w-full bg-transparent border-b rounded-none justify-between md:justify-start md:space-x-6 flex-wrap px-1">
      <TabsTrigger 
        value="books" 
        className="relative px-2 py-3 h-auto rounded-none data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:text-bookverse-accent data-[state=active]:font-medium flex items-center gap-2"
